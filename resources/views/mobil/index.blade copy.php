...
{{-- Detail Mobil Modal --}}
<div class="modal fade animate__animated animate__fadeInUp animate__faster" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-4 shadow-xl border-0">
            ...
            <div class="modal-body p-4">
                {{-- Section 1: Informasi Dasar Mobil --}}
                <div class="section-card mb-4"> {{-- Removed section-card-primary --}}
                    <h6 class="fw-bold mb-3 text-dark pb-2 border-bottom-dashed"><i class="bi bi-info-circle-fill me-2 text-primary"></i> Informasi Dasar Mobil</h6>
                    <div class="row row-cols-1 row-cols-md-2 g-3">
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-tag me-2"></i>Kode Mobil:</p>
                                <p class="detail-value" id="detail-kode"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-car-front me-2"></i>Jenis Mobil:</p>
                                <p class="detail-value" id="detail-jenis"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-building me-2"></i>Merek Mobil:</p>
                                <p class="detail-value" id="detail-merek"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-subtract me-2"></i>Tipe Mobil:</p>
                                <p class="detail-value" id="detail-tipe"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-gear me-2"></i>Transmisi:</p>
                                <p class="detail-value" id="detail-transmisi"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-calendar-event me-2"></i>Tahun Pembuatan:</p>
                                <p class="detail-value" id="detail-tahun"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-palette me-2"></i>Warna Mobil:</p>
                                <p class="detail-value" id="detail-warna"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-fuel-pump me-2"></i>Bahan Bakar:</p>
                                <p class="detail-value" id="detail-bahanbakar"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-journal-text me-2"></i>Nomor Polisi:</p>
                                <p class="detail-value" id="detail-nopolisi"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-calendar-check me-2"></i>Tanggal Masuk:</p>
                                <p class="detail-value" id="detail-tanggalmasuk"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-patch-check me-2"></i>Status Mobil:</p>
                                <p class="detail-value" id="detail-status"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-truck me-2"></i>Ketersediaan:</p>
                                <p class="detail-value" id="detail-ketersediaan"></p>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- Section 2: Informasi Harga & Dokumen --}}
                <div class="section-card"> {{-- Removed section-card-info --}}
                    <h6 class="fw-bold mb-3 text-dark pb-2 border-bottom-dashed"><i class="bi bi-file-earmark-ruled-fill me-2 text-info"></i> Informasi Harga & Dokumen</h6>
                    <div class="row row-cols-1 row-cols-md-2 g-3">
                        <div class="col-12"> {{-- Ambil lebar penuh untuk harga --}}
                            <div class="detail-item detail-item-highlight"> {{-- Highlight harga --}}
                                <p class="detail-label"><i class="bi bi-cash-stack me-2"></i>Harga Mobil:</p>
                                <p class="detail-value text-success fw-bold fs-4" id="detail-harga"></p> {{-- Font lebih besar untuk harga --}}
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-card-heading me-2"></i>No. Rangka:</p>
                                <p class="detail-value" id="detail-rangka"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-box-seam me-2"></i>No. Mesin:</p>
                                <p class="detail-value" id="detail-mesin"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-file-earmark-text me-2"></i>No. BPKB:</p>
                                <p class="detail-value" id="detail-bpkb"></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="detail-item">
                                <p class="detail-label"><i class="bi bi-calendar-date me-2"></i>Masa Berlaku Pajak:</p>
                                <p class="detail-value" id="detail-masapajak"></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .custom-table th:nth-child(1), .custom-table td:nth-child(1) { width: 100px; }
    .custom-table th:nth-child(2), .custom-table td:nth-child(2) { width: 100px; }
    .custom-table th:nth-child(3), .custom-table td:nth-child(3) { width: 100px; }
    .custom-table th:nth-child(4), .custom-table td:nth-child(4) { width: 120px; }
    .custom-table th:nth-child(5), .custom-table td:nth-child(5) { width: 100px; }
    .custom-table th:nth-child(6), .custom-table td:nth-child(6) { width: 80px; }
    .custom-table th:nth-child(7), .custom-table td:nth-child(7) { width: 90px; }
    .custom-table th:nth-child(8), .custom-table td:nth-child(8) { width: 110px; }
    .custom-table th:nth-child(9), .custom-table td:nth-child(9) { width: 120px; }
    .custom-table th:nth-child(10), .custom-table td:nth-child(10) { width: 120px; }
    .custom-table th:nth-child(11), .custom-table td:nth-child(11) { width: 100px; }
    .custom-table th:nth-child(12), .custom-table td:nth-child(12) { width: 140px; }
    .custom-table th:nth-child(13), .custom-table td:nth-child(13) { width: 150px; }
    .custom-table th:nth-child(14), .custom-table td:nth-child(14) { width: 280px; }
    ...
    /* Custom styles for the detail modal */
    .detail-item {
        background-color: transparent; /* No background for individual items */
        border-radius: 0.75rem;
    ...
    /* Dashed border for sub-headings in modal */
    .modal-body h6.border-bottom-dashed {
    ...
    /* Styles for the section-card wrapper */
    .section-card {
        background-color: #ffffff; /* Reverted to white background for section cards */
    ...
    /* Remove bottom margin from the last section-card if it's the last element */
    .modal-body .section-card:last-of-type {
        margin-bottom: 0;
    }


    /* Highlight style for important detail items (e.g., price) */
    ...
    .detail-item-highlight .detail-label i {
        color: #155724;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (detailModal) {
            detailModal.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('detail-transmisi').textContent = data.transmisi;
        ...
        const transmisiFilter = document.getElementById('transmisiFilter');
        ...
        function applyFiltersAndSearch() {
            ...
            const selectedTransmisi = transmisiFilter.value.toLowerCase().trim();
            ...
            tableRows.forEach(row => {
                ...
                const transmisi = row.getAttribute('data-transmisi').toLowerCase();
        ...
        transmisiFilter.addEventListener('change', applyFiltersAndSearch);
