                        ...
                        <tbody>
                            @if($servis->items->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm total" name="item_total[]" value="{{ number_format((float) $old('item_total.' . $key, $item->item_total), 0, '', '.') }}" readonly></td>
